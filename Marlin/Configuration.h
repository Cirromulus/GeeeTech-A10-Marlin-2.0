...
#define STRING_CONFIG_H_AUTHOR "(TMC2208 version of AkosW, Config for A10)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "        Yeeeeee.....      " //SHORT_BUILD_VERSION // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "Lets burn!" //WEBSITE_URL         // will be shown during bootup in line 2
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
 ...
 //Default  Geeetech A10
  //#define DEFAULT_Kp 11.93//22.2
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //Default A10 24V Geeetech SuperPlate
  //#define DEFAULT_bedKp 182.46//10.00
  //#define DEFAULT_bedKi 35.92//.023
  //#define DEFAULT_bedKd 231.70//305.4
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.3, 80.8, 400, 185 }
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE    13 // Z Clearance for Deploy/Stow
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define RIGHT_PROBE_BED_POSITION (X_BED_SIZE - MIN_PROBE_EDGE - 5)        //But why 5? RIGHT_PROBE_BED_POSITION <= MAX_PROBE_X
 ...
 */
#define NOZZLE_PARK_FEATURE   //ADV_PAUSE
